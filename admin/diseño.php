            ...
            <div class="container-fluid">
                ...
                <div class="mt-4">
                    <table class="table table-hover">
                        ...
                        <?php 
                        $sel = $conn ->query("SELECT * FROM tbldiseño");
                            $cont=0;
                        ...
                        <tr>
                            ...
                            <?php
                            if ($fila['cod_diseño']==1){
                                ?>
                                <td><a href="#" onclick="preguntar(<?php echo $fila['cod_diseño']?>)"><button class="btn btn-color" disabled>Eliminar</button></a></td>
                            <?php
                            }else{
            ...
            Swal
                ...
                .then(resultado => {
                    if (resultado.value) {
                        ...
                        window.location.href="controlador/eliminar_diseno.php?cod_diseño="+id
                    } else {
                        // Dijeron que no
