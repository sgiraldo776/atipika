        ...
        <div class="mt-4">
            <table class="table table-hover">
                ...
                <?php 
                        ...
                        ?>
                <tr>
                    <td><img style="width: 130px; height:150px;" src="<?php echo $urlimagen.$fila['imagen'] ?>"
                            alt="<?php echo $fila['productos'] ?>"></td>
                    ...
                    <td><a href="#" onclick="preguntar(<?php echo $fila['id_carrito']?>)"><button
                                class="btn btn-color">Quitar</button></a></td>
                </tr>
                <?php
                            $cont++;
                        }
            ...
            <form method="post" action="https://sandbox.checkout.payulatam.com/ppp-web-gateway-payu">
                ...
                <?php
                    ...
                    if (!empty($suma)){
                        ?>
                <div class="col-12 d-flex" style=" float: right;">
                    <div class="ml-auto">
                        <h4>Total: <?php echo $suma ?></h4>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 my-3 my-lg-0 text-lg-center text-center">
                    <a class="redes btn btn-social mx-3" href="https://cutt.ly/gjg4kjS" target="_blank"><i
                            class="fab fa-whatsapp"></i></a>
                    <a class="redes btn btn-social mx-3" href="wa.link/vtu4ai" target="_blank"><i
